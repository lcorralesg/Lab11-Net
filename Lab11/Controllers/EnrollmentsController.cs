...
namespace Lab11.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EnrollmentID,Date,StudentID,CourseID")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EnrollmentID,Date,StudentID,CourseID")] Enrollment enrollment)
        {
